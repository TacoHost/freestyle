<?
/*
Template Name: Шабло для страницы Аква-Комплекс
*/
...
<link href="<? bloginfo("template_directory" ); ?>/less/complex-layout.min.css" rel="stylesheet">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                                                ...
                                                <? the_title('<h1 class="after-image after-image-water">','</h1>'); ?>
                                            ...
                                            <? if($main=get_field(main))
                                            {
                                                ...
                                                foreach($main as $one_main)
                                                {
                                                    ...
                                                    { ?>
                                                        <h3 class="after-image after-image-water">
                                        ...
                                        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 icons">
                                            <div class="subnavi-block">
                                                <i>
                                                    <span class="zi-aqua1"></span>
                                                </i>
                                                <i>
                                                    <span class="zi-aqua2"></span>
                                                </i>
                                                <i>
                                                    <span class="zi-aqua3"></span>
                                                </i>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <? get_footer( ); ?>
<script src="<? bloginfo("template_directory" ); ?>/js/water-complex.js"></script>
