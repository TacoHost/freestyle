<?
/*
Template Name: Шабло для страницы Банно-термальный комплекс
*/
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                    ...
                    <? the_title('<h1 class="after-image after-image-termo">','</h1>'); ?>
                    ...
                    <? if($main=get_field(main))
                    {
                        ...
                        foreach($main as $one_main)
                        {
                            ...
                            { ?>
                                <h3 class="after-image after-image-termo">
                ...
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 icons">
                    <div class="subnavi-block">
                        <i>
                            <span class="zi-tk1"></span>
                        </i>
                        <i>
                            <span class="zi-tk2"></span>
                        </i>
                        <i>
                            <span class="zi-tk3"></span>
                        </i>
                    </div>
...
<? get_footer( ); ?>
<script src="<? bloginfo("template_directory" ); ?>/js/termo-complex.js"></script>
